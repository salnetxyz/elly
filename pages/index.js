...
const Home = () => {
  return (
   ...
   <div className="bg-white sticky top-0 z-30"> 
    ...
    <a href="/demos" className="text-sm font-semibold px-5 rounded-xl py-1.5 hover:bg-indigo-700 bg-indigo-500 text-white flex gap-1">
            Demos
    </a>
    </div>

    <div className="flex-none">
    <a href="/" className="text-sm font-semibold pl-3 sm:pl-6 rounded-full py-1 text-white flex gap-1">
