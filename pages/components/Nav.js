...
const Nav = ()=>{
    ...
    <div className="flex-none">
    <Link href="/" className="text-sm font-semibold pr-3 sm:pl-6 rounded-full py-1 text-white flex gap-1">
    ...
    <div className="flex-none">
    <Link href="/templates" className="text-sm font-semibold px-5 rounded-xl py-1.5 hover:bg-neutral-700 bg-black text-white flex gap-1">
            Templates
    </Link>
    </div>
